...
OEMBED_TEXT_PARSER = getattr(
    settings, 'OEMBED_TEXT_PARSER', 'oembed.parsers.text.TextParser')
OEMBED_HTML_PARSER = getattr(
    settings, 'OEMBED_HTML_PARSER', 'oembed.parsers.html.HTMLParser')
...
OEMBED_DEFAULT_PARSE_HTML = getattr(
    settings, 'OEMBED_DEFAULT_PARSE_HTML', True)
...
OEMBED_ALLOWED_SIZES = getattr(
    settings, 'OEMBED_ALLOWED_SIZES', [(x, x) for x in xrange(100, 900, 100)])
OEMBED_THUMBNAIL_SIZE = getattr(
    settings, 'OEMBED_THUMBNAIL_SIZE', ((200, 200),))
